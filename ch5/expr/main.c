...
/* This is the program pcalc as available in ./ch4/pcalc/ slightly adapted to
receive command line inputs as defined in Exercise 5-10. */
...
int main(int argc, char *argv[]) {
  ...
  readarguments(argc, argv); // Changed from pcalc!
